const Keyboard = {
    ...
    init() {
        // Remove existing keyboard if already initialized
        ...
        document.querySelectorAll(".use-keyboard-input").forEach(element => {
            element.removeEventListener("focus", this._handleFocusEvent); // Remove any previous events
        });
        ...
        document.querySelectorAll(".use-keyboard-input").forEach(element => {
            element.addEventListener("focus", this._handleFocusEvent.bind(this)); // Register new events
        });
