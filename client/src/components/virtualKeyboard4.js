const Keyboard = {
    ...
    init() {
        // Si el teclado ya está inicializado, elimínalo para reinicializar correctamente
        ...
        document.querySelectorAll(".use-keyboard-input").forEach(element => {
            element.removeEventListener("focus", this._handleFocusEvent); // Eliminar el evento anterior
            element.addEventListener("focus", this._handleFocusEvent.bind(this));
        });
