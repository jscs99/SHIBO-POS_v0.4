...
function CartPage() {
  ...
  const onFinish = async (values) => { 
    try {
      ...
      saveBill(customerCode, values, documentType);
    } catch (error) {
      ...
      >
        ...
        <Form.Item 
          ...
          <Select onChange={(value) => setDocumentType(value)}>
            ...
            <Select.Option value="Comprobante de Crédito Fiscal">Crédito Fiscal</Select.Option>
            <Select.Option value="Nota de Débito">Nota de Débito</Select.Option>
          </Select>
        </Form.Item>
        <Form.Item name="customerCode" label="Buscar cliente">
          ...
          {!selectedCustomer && (
            ...
            <Form.Item name="customerDoc" label="Documento de Identificación" required="false">
              <Select>
